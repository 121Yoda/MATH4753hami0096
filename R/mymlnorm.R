#' @title Maximum Likelihood Estimate on a Normal Distribution
#'
#' @param x A vector of sample data
#' @param mu A sequence of values to maximize for mu
#' @param sig A sequence of values to maximize for sigma
#' @param ... Additional text to place on the graph
#'
#' @importFrom graphics contour
#' @importFrom stats sd
#'
#' @return A graph containing the MLEs of mu and sigma, and a list of key values
#' @export
#'
#' @examples
